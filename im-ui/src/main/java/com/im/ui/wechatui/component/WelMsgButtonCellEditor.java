...
public class WelMsgButtonCellEditor  extends DefaultCellEditor  {
	...
	public WelMsgButtonCellEditor(int typeColumn,int valueColumn)
	{
	    ...
	    {  
	        ...
	        {  
	            ...
	            {   
	               ...
	               Object msgTypeObj=table.getValueAt(parentPanel.getRow(), typeColumn); 
	                FileNameExtensionFilter filter = getfilter(msgTypeObj);
	                table.setValueAt(eventOnImport(new JButton(),filter), parentPanel.getRow(), valueColumn); 
	            }  
	        });   
	    }  
...
//		upLoadButton.setBackground(table.getSelectionBackground());
		...
		Object msgTypeObj=table.getValueAt(row,typeColumn);
