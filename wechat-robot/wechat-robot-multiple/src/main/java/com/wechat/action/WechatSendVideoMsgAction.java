...
public class WechatSendVideoMsgAction extends AbstractHttpAction{

	 private static final Logger LOGGER = LoggerFactory.getLogger(WechatSendVideoMsgAction.class);
	
	 private String mediaId;
	 private String toUser;
	 
	public WechatSendVideoMsgAction(QQContext context, QQActionListener listener,String mediaId,String toUser) {
	...
	protected QQHttpRequest onBuildRequest() throws QQException {
		String url = getContext().getSession().getBase_uri() + "/webwxsendvideomsg?fun=async&f=json&pass_ticket="+getContext().getSession().getPass_ticket(); 
	...
	private String getPostBodyStr(QQSession meta) {
		...
		Msg.put("Type", WechatSendMsgType.VIDEO_MSG);
